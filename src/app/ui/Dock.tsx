...
export const LeftDock = () => (
    <ul className='fixed bottom-0 sm:left-5 lg:left-10 w-10 hidden md:flex flex-col after:w-px after:h-24 after:m-auto after:mt-5 after:bg-white'>
...
export const RightDock = () => (
    <div className='fixed bottom-0 right-5 lg:right-10 w-10 hidden md:flex flex-col after:w-px after:h-24 after:m-auto after:mt-5 after:bg-white'>
