...
const getFaElement = (icon: IconDefinition, href: string) => (
    <li>
        <Link href={href} target='_blank' rel='noopener noreferrer'>
            <FontAwesomeIcon icon={icon} className='w-5 h-auto mx-auto my-3 hover:-translate-y-[3px] transition-transform'/>
        </Link>
    </li>
)
...
export const RightDock = () => (
    <div className='fixed bottom-0 right-10 w-10 flex flex-col after:w-px after:h-24 after:m-auto after:mt-5 after:bg-white'>
        <Link href="mailto:phurin.nrt@gmail.com" className='[writing-mode:vertical-rl] mx-auto my-5 hover:-translate-y-1 transition-transform'>phurin.nrt@gmail.com</Link>
    </div>
);